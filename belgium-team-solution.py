...
input_dir = './input'
output_dir = './output-greedy-approach'
...
for FILE in os.listdir(input_dir):
    ...
    # Scores of the books (book_scores[i] = score of book i)
    ...
    # Function to get the best remaining books from a library
    ...
    # Key function for our max function
    def score(library, assigned_books, curr_time, assigned_libraries):
        ...
        # Score is the sum of book scores divided by signup time
    ...
    total_score = 0
    output_file_path = os.path.join(output_dir, '{}.out'.format(FILE))
